...
<div class="confirmPayPageDiv">
    ...
    <div class="confirmPayOrderItemDiv">
        ...
        <table class="confirmPayOrderItemTable">
            ...
            <c:forEach items="${order.orderItems}" var="oi">
                <tr>
                    <td><img width="50px" src="img/productSingleMiddle/${oi.product.firstProductImage.id}.jpg"></td>
        ...
        <div class="confirmPayOrderItemText pull-right">
            实付款： <span class="confirmPayOrderItemSumPrice">￥<fmt:formatNumber type="number" value="${order.orderMoney}" minFractionDigits="2"/></span>
        </div>
    ...
    <div class="confirmPayButtonDiv">
        <div class="confirmPayWarning">请收到货后，再确认收货！不然您可能钱货两空！</div>
        <a href="foreOrderConfirmPay?oid=${order.id}"><button class="confirmPayButton">确认支付</button></a>
    </div>
</div>