            ...
            <div>
                ...
                <table class="addressTable">
                    <tr>
                        ...
                        <td><textarea name="address" placeholder="请如实填写详细收货地址，例如街道、门牌号码、楼层和房间号等信息"></textarea></td>
                    </tr>
                    <tr>
                        <td>邮政编码</td>
                        <td><input  name="post" placeholder="如果不清楚邮递区号，请填写000000" type="text"></td>
                    </tr>
                    <tr>
            ...
            <table class="productListTable">
                ...
                <c:forEach items="${ois}" var="oi" varStatus="st" >
                    <tr class="orderItemTR">
                        <td class="orderItemFirstTD"><img class="orderItemImg" src="img/productSingleMiddle/${oi.product.firstProductImage.id}.jpg"></td>
