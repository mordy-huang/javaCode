                        ...
                        $.get(
                            ...
                            function(result){
                                if("success"==result){
                                    ...
                                    alert("已加入购物车");
                                    $(".addCartButton").attr("enable","enable");
...
<div class="imgAndInfo">
    <div class="imgInimgAndInfo">
        ...
        <div class="smallImageDiv">
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img src="img/productSingleSmall/${pi.id}.jpg" bigImageURL="img/productSingle/${pi.id}.jpg" class="smallImage">
            </c:forEach>
        </div>
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="buyDiv">
            ...
            <a class="addCarLink" ><button class="addCartButton"><span class="glyphicon glyphicon-shopping-cart"></span>加入购物车</button></a>
<%--            <a class="buyLink" href="forebuyone?pid=${p.id}"><button class="buyButton">立即购买</button></a>--%>
