...
<%@include file="../include/fore/home/searchMoresimple.jsp"%>
    ...
    <div class="reviewProductInfoDiv">
        ...
        <div class="reviewProductInfoRightDiv">
            ...
            <table class="reviewProductInfoTable">
                <tr>
                    <td width="75px">价格</td>
                    <td><span class="reviewProductInfoTablePrice">￥<fmt:formatNumber type="number" value="${p.promotePrice}" minIntegerDigits="2"/></span>元
                    </td>
                </tr>
                <tr>
                    <td>配送方式</td>
                ...
                <tr>
                    <td>月销量</td>
                    <td>
                        <span style="color: #C40000;font-size: 14px;font-weight: bold">
                           ${p.saleCount}
                        </span>件
                    </td>
                </tr>
            ...
            <div class="reviewProductInfoRightBelowDiv">
               ...
               <span class="reviewProductInfoRightBelowText" >现在查看的是 您所购买商品的信息
                    于<fmt:formatDate value="${o.createDate}" pattern="yyyy年MM月dd"/>下单购买了此商品
               </span>
            </div>
        </div>
